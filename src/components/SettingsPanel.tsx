...
export const SettingsPanel: React.FC<SettingsPanelProps> = ({
    ...
    return (
        <>
            ...
            />
            {/* Panel */}
            <div className={`fixed top-0 right-0 h-full w-80 bg-white dark:bg-gray-800 shadow-2xl transform transition-transform duration-300 z-50 p-6 overflow-y-auto ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
