    ...
    },
    {
        ...
        lessons: [
            ...
            },
            {
                ...
                handPosition: 'RH_C_POS',
                constraints: {
                    trebleRange: ["c/4", "d/4", "e/4"], bassRange: [], rhythms: ["q", "h", "w"], maxJumps: 1, chordsAllowed: false, numNotes: 69,
                    presetMelody: {
                        treble: [
                            { keys: ["c/4"], duration: 'q' },
                            { keys: ["d/4"], duration: 'q' },
            ...
            },
            {
                ...
                handPosition: 'RH_HIGH_C_POS',
                constraints: {
                    trebleRange: ["c/4", "d/4", "e/4", "f/4", "g/4", "a/4", "b/4", "c/5"], bassRange: [], rhythms: ["q", "h"], maxJumps: 2, chordsAllowed: false, numNotes: 47,
                    presetMelody: {
                        treble: [
                            { keys: ["d/4"], duration: 'q' },
                            { keys: ["c/4"], duration: 'h' },
    ...
    },
    {
        ...
        lessons: [
            ...
            },
            {
                ...
                handPosition: 'LH_LOW_C_POS',
                constraints: {
                    trebleRange: [], bassRange: ["b/2", "c/3", "d/3", "e/3", "g/3"], rhythms: ["q", "h"], maxJumps: 3, chordsAllowed: false, numNotes: 46,
                    presetMelody: {
                        treble: [
                        ],
                        bass: [
            ...
            },
            {
                ...
                handPosition: 'LH_LOW_C_POS',
                constraints: {
                    trebleRange: [], bassRange: ["g/2", "a/2", "c/3", "d/3", "e/3", "f/3"], rhythms: ["q", "h"], maxJumps: 3, chordsAllowed: false, numNotes: 63,
                    presetMelody: {
                        treble: [
                        ],
                        bass: [
    ...
    },
    {
        ...
        lessons: [
            ...
            },
            {
                ...
                handPosition: 'GRAND_C_POS',
                constraints: {
                    trebleRange: ["d/5", "e/5", "f/5", "g/5", "a/5"], bassRange: ["a/2", "c/3", "d/3", "e/3", "f/3", "g/3", "a/3"], rhythms: ["q", "h"], maxJumps: 5, chordsAllowed: false, numNotes: 112,
                    presetMelody: {
                        treble: [
                            { keys: ["e/5"], duration: 'q' },
                            { keys: ["a/5"], duration: 'q' },
